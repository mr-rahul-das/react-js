...
function Footer() {
  return (
    <footer className="bg-dark text-white text-center py-3 mt-5">
      <p className="mb-0"> <i className="bi bi-c-circle"></i> 2025 My Website. All Rights Reserved.</p>
      <div className="row mt-3">
        ...
        <div className="col">
            <h5>Contacts us:</h5>
            <a href="#" className="icon-link mb-2">
                <i className="bi bi-whatsapp mb-2"></i> 
            ...
            <a href="#" className="icon-link mb-2">
                ...
                <i className="bi bi-telephone mb-2"></i>
                <i>9800428444</i>
            </a>
